...
class ControllerExtensionModuleOctProductModules extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->post['infinite_scroll'])) {
            $data['infinite_scroll'] = $this->request->post['infinite_scroll'];
        } elseif (!empty($module_info) && isset($module_info['infinite_scroll'])) {
            $data['infinite_scroll'] = $module_info['infinite_scroll'];
        } else {
            $data['infinite_scroll'] = 0;
        }
