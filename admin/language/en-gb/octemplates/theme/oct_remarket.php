<?php
// Heading
$_['heading_title']                    = 'ReMarket OCTemplates - Template Settings';
...
//PopUpCart
$_['text_popup_cart']           = 'Sidebar cart';
$_['entry_show_popup_cart']         = 'Enable sidebar cart';
$_['entry_popup_is']               = 'When adding items to the cart';

//LiveSearch
$_['text_live_search']           = 'Live search';
$_['entry_show_live_search']       = 'Enable live search';
$_['entry_live_search_symbols']		   = 'Number of characters to start searching for products';
$_['entry_live_search_results']		   = 'Number of characters to start searching for categories and manufacturers';
...
$_['entry_show_live_tags']            = 'Search in product tags';
$_['entry_show_live_search_tags']     = 'Perform search on product tags';
$_['entry_live_search_category_image'] = 'Show category image';
$_['entry_live_search_found_in_categories'] = 'Show categories where products are found';
$_['entry_show_live_search_found_in_categories'] = 'Show categories where products are found (if no categories are found for the query)';
$_['entry_live_search_manufacturer']   = 'Search manufacturers';
$_['entry_live_search_manufacturer_image'] = 'Show manufacturer image';
$_['entry_show_live_search_fallback'] = 'Perform additional search with corrected queries?';
$_['entry_show_live_search_fallback_help'] = 'If nothing is found for the entered query, the system will perform an additional search in the database with corrected or similar queries.';
$_['entry_live_search_fallback_start'] = 'Number of characters to start additional search';
$_['entry_show_live_search_search_fallback_start'] = 'Number of characters to start additional search with corrected queries';
$_['entry_live_search_limit_products'] = 'Product limit';
$_['entry_show_live_search_limit_products'] = 'Product limit in search results';
$_['entry_live_search_limit_entities'] = 'Category and manufacturer limit';
$_['entry_show_live_search_limit_entities'] = 'Category and manufacturer limit in search results';
$_['entry_show_live_search_status'] = 'Module status';
$_['entry_show_live_search_category'] = 'Perform category search';
$_['entry_show_live_search_manufacturer'] = 'Perform manufacturer search';
$_['entry_show_live_search_manufacturer_images'] = 'Show manufacturer images in search results';
$_['entry_show_live_search_category_images'] = 'Show category images in search results';
$_['entry_show_live_search_price'] = 'Show price in search results';
$_['entry_show_live_search_model'] = 'Show model in search results';
$_['entry_show_live_search_sku'] = 'Show SKU in search results';
$_['entry_show_live_search_description'] = 'Search in product description';
$_['entry_show_live_search_delay'] = 'Delay before starting search (in milliseconds)';
$_['entry_show_live_search_count_symbol'] = 'Number of characters to start product search';
$_['entry_show_live_search_count_subresults'] = 'Number of characters to start category and manufacturer search';
...
$_['text_menu_display_option_1'] = 'Main megameu (main categorylist)';
...
$_['text_reviews_limit']			   = 'Reviews and questions limit';
$_['text_timer_enddate']			   = 'Timer end date';
$_['text_timer_enddate_help']		   = 'Format: <b>yyyy-mm-dd</b><br /> If a custom promotion end date is specified in this field, the timer will display this date. If no custom promotion end date is specified, the timer will display the promotion end date from the database. <br/><b>If you want the promotion end date to be until the end of the day, specify: 0000-00-00</b>';
...
$_['entry_phone_regex']                = 'Regular expression for phone validation in modules';
...
$_['entry_category_infinite_scroll']   = 'Enable infinite scrolling';
$_['entry_category_show_type']         = 'Display option on mobile';
$_['entry_category_show_type_deff']    = 'Default';
...
$_['entry_bought_together']           = 'Bought together';
$_['text_button_generate'] = 'Generate';
$_['text_generating'] = 'Generating...';
$_['text_generated'] = 'Generation completed successfully';
$_['text_generated_failed'] = 'Generation failed';
$_['text_bought_together_cron'] = "Enter CRON password";
$_['text_bought_together_cron_url'] = "Your link for the CRON task";
$_['text_copy_success'] = "Link successfully copied";
$_['text_copy_error'] = "Error copying the link";
...
$_['entry_help_text']                 = '<div class="panel panel-info">
  <div class="panel-heading">
    Thank you for purchasing the ReMarket template!
  </div>
  <div class="panel-body">
<p>Online documentation is available here.: <a href="https://rmdocs.octemplates.net/" target="_blank">https://rmdocs.octemplates.net/</a></p>
</div></div>
...
$_['entry_captcha_popup_purchase']     = "ReMarket - Popup purchase";
$_['entry_captcha_sreview_reviews']     = "ReMarket - Shop reviews";
...
$_['help_phone_regex']                 = 'You can enter a regular expression to validate the phone number in the template modules.<br> For example: /^\+38\s?\(?(?:050|063|066|067|068|073|077|091|092|093|094|095|096|097|098|099)\)?[\s-]?\d{3}[\s-]?\d{2}[\s-]?\d{2}$/';
$_['help_bought_together']             = '<div style="color: red">Come up with a CRON password, save the template settings, and add a CRON job on the hosting/server to run once a day.</div>';
$_['help_bought_together_cron']         = 'Add this CRON task on the hosting/server to execute once a day.';
...
$_['error_date_format']                = 'Invalid format. Please use the format: yyyy-mm-dd';