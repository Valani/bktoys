...
class ModelExtensionModuleOCFilterSetting extends Model {
  ...
  protected function getCreateTables() {
    ...
    $sql['ocfilter_attribute_cache'] = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "ocfilter_attribute_cache` (`product_id` INT(11) UNSIGNED NOT NULL DEFAULT '0', `attribute_id` INT(11) UNSIGNED NOT NULL DEFAULT '0', `language_id` TINYINT UNSIGNED NOT NULL DEFAULT '0', `key` INT(11) UNSIGNED NOT NULL DEFAULT '0', `text` TEXT NOT NULL COLLATE 'utf8_general_ci', PRIMARY KEY (`product_id`, `attribute_id`, `language_id`) USING BTREE, INDEX `key` (`key`) USING BTREE, INDEX `language_id` (`language_id`) USING BTREE, INDEX `attribute_id` (`attribute_id`) USING BTREE) COLLATE='utf8_general_ci' ENGINE=MyISAM";
    ...
    $sql['ocfilter_filter_to_category'] = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "ocfilter_filter_to_category` (`filter_id` INT(11) UNSIGNED NOT NULL, `source` TINYINT(1) UNSIGNED NOT NULL DEFAULT '0', `category_id` INT(11) UNSIGNED NOT NULL, `status` TINYINT(1) UNSIGNED NOT NULL DEFAULT '0',PRIMARY KEY (`category_id`, `filter_id`, `source`) USING BTREE,INDEX `category_id` (`category_id`) USING BTREE) COLLATE='utf8_general_ci' ENGINE=MyISAM";
